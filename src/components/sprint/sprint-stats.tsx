...
import { ListTodo, CheckCircle2, AlertCircle, Timer, TrendingUp, Target, GitBranch, Ban } from "lucide-react";
import type { SprintStatistics } from "@/types/sprint";
...
export function SprintStats({ stats, loading, className }: SprintStatsProps) {
  if (loading) {
    return (
  ...
  const statCards = [
    ...
    { label: "Avg Velocity", value: stats.averageVelocity, icon: GitBranch, color: "text-cyan-500" },
  ];
