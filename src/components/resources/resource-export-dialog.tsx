...
export function ResourceExportDialog({ isOpen, onClose, onExport, exporting }: ResourceExportDialogProps) {
  const [format, setFormat] = useState<"csv" | "json">("csv");

  return (
    <Dialog isOpen={isOpen} onClose={onClose} title="Export Report" size="sm">
